...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	//END NEW//////////////////////////////
	paper.LoadTGA("Color2.tga");
	paper.BuildGLTexture();
	paper.ReleaseImage();

	madera.LoadTGA("arbol.tga");
	madera.BuildGLTexture();
	madera.ReleaseImage();

	pino.LoadTGA("Follaje.tga");
	pino.BuildGLTexture();
	pino.ReleaseImage();
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix();
		...
		glPushMatrix();
			glTranslatef(6,0,-4);
			object.cilindro(0.5,2,30,madera.GLindex);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(6, 2, -4);
			object.cono(5,2,30,pino.GLindex);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(6, 7.4, -4);
			glEnable(GL_ALPHA_TEST);
			glAlphaFunc(GL_GREATER, 0.1f);
			object.esfera(0.4, 20, 20, e2.GLindex);
			glDisable(GL_ALPHA_TEST);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(3.6, 2, -4);
			glEnable(GL_ALPHA_TEST);
			glAlphaFunc(GL_GREATER, 0.1f);
			object.esfera(0.4, 20, 20, e3.GLindex);
			glDisable(GL_ALPHA_TEST);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(8.4, 2, -4);
			glEnable(GL_ALPHA_TEST);
			glAlphaFunc(GL_GREATER, 0.1f);
			object.esfera(0.4, 20, 20, paper.GLindex);
			glDisable(GL_ALPHA_TEST);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(6, 2, -1.6);
			glEnable(GL_ALPHA_TEST);
			glAlphaFunc(GL_GREATER, 0.1f);
			object.esfera(0.4, 20, 20, e4.GLindex);
			glDisable(GL_ALPHA_TEST);
		glPopMatrix();
		...
		glPushMatrix();
			...
			glPushMatrix();
				glColor3f(1.0, 1.0, 1.0);
				glScalef(0.5, 0.5, 0.5);
				mesa.prisma2(t_Ajedrez2.GLindex, t_metal01.GLindex);
			glPopMatrix();
			...
			glPushMatrix();
				glColor3f(1.0, 1.0, 1.0);
				glTranslatef(2, 0, -0.25);
				glScalef(0.5, 0.5, 2.0);
				mesa.prisma2(t_metal01.GLindex, t_metal01.GLindex);
			glPopMatrix();
			...
			glPushMatrix();
				glColor3f(1.0, 1.0, 1.0);
				glTranslatef(2, -0.375, 1.0);
				glScalef(0.5, 1.25, 0.5);
				mesa.prisma2(madera2.GLindex, madera2.GLindex);
			glPopMatrix();
			glPushMatrix();
				glColor3f(1.0, 1.0, 1.0);
				glTranslatef(2, -0.375, -1.5);
				glScalef(0.5, 1.25, 0.5);
				mesa.prisma2(madera2.GLindex, madera2.GLindex);
			glPopMatrix();
			glPushMatrix();
				glColor3f(1.0, 1.0, 1.0);
				glTranslatef(-0.5, -0.375, 1.0);
				glScalef(0.5, 1.25, 0.5);
				mesa.prisma2(madera2.GLindex, madera2.GLindex);
			glPopMatrix();
			glPushMatrix();
				glColor3f(1.0, 1.0, 1.0);
				glTranslatef(-0.5, -0.375, -1.5);
				glScalef(0.5, 1.25, 0.5);
				mesa.prisma2(madera2.GLindex, madera2.GLindex);
			glPopMatrix();
